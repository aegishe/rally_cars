...
# ---- 里程（特殊赛段 km）与地形 cr ----
# 环塔：SS1 245.8(新华网) SS3 468.95 SS4 91.03 SS5 281.32 SS7 285.87(新华网)
#       SS8 288.10 SS9 353.66 SS11 21.88(捷途官方) SS13 159.32；SS2/6/10/12 待补
HT_DIST = {1: 245.8, 3: 468.95, 4: 91.03, 5: 281.32, 7: 285.87, 8: 288.10, 9: 353.66, 11: 21.88}
HT_TERRAIN = {1: '戈壁/砂石', 3: '戈壁长耐力', 4: '戈壁峡谷', 5: '魔鬼(沙+戈壁)',
              7: '沙海老兵', 8: '克里雅河沙漠', 9: '纯沙漠', 11: '短冲刺'}
TERRAIN_CR = {'戈壁/砂石': 0.040, '戈壁长耐力': 0.035, '戈壁峡谷': 0.050,

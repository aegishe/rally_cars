...
fig.tight_layout()
fig.savefig(os.path.join(OUT, 'fig1_pw_laptime.png'), dpi=150)
plt.close(fig)
print('fig1 done')
...
fig.tight_layout()
fig.savefig(os.path.join(OUT, 'fig2_k_value.png'), dpi=150)
plt.close(fig)
print('fig2 done')
...
ax.grid(alpha=0.3, lw=0.5)
fig.tight_layout()
fig.savefig(os.path.join(OUT, 'fig3_u9x_power.png'), dpi=150)
plt.close(fig)
print('fig3 done')
...
fig.tight_layout()
fig.savefig(os.path.join(OUT, 'fig4_residual.png'), dpi=150)
plt.close(fig)
print('fig4 done')

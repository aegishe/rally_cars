...
fig.tight_layout()
fig.savefig(os.path.join(OUT, 'chapter3-1-pw-laptime.png'), dpi=150)
plt.close(fig)
print('fig1 done')
...
ax.grid(alpha=0.3, lw=0.5)
fig.tight_layout()
fig.savefig(os.path.join(OUT, 'chapter3-2-weight-laptime.png'), dpi=150)
plt.close(fig)
print('fig2 done')
...
fig.savefig(os.path.join(OUT, 'chapter3-3-cross-scene.png'), dpi=150)
plt.close(fig)
print('fig3 done')
...
fig.tight_layout()
fig.savefig(os.path.join(OUT, 'chapter3-4-residual.png'), dpi=150)
plt.close(fig)
print('fig4 done')

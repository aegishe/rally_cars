...
| `docs/纽北对照三轴备忘-布局重量兑现.md` | **内部备忘（不发布）**：对照必须按三轴拆（布局 44% / 重量 1.73 / 残差 −5.6~+5.3%）；同布局干净对照（SU7 量产 vs 原型、Plaid vs Track Pkg）；911×Taycan 对照降级为跨布局粗参照；腾势 Z 最直接对标 Taycan，及"顶天 6:45"的强假设边界；腾势 Z 重量口径勘误（2240/2290/2580）；纽北无"敞篷/豪华 GT"官方类别 |
